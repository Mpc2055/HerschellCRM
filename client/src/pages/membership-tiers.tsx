...
const MembershipTiers: React.FC = () => {
  ...
  React.useEffect(() => {
    if (isDialogOpen) {
      if (editingTier) {
        ...
        const benefitsArray = JSON.parse(editingTier.benefits as string);
  ...
  const handleCreateTier = async (data: TierFormValues) => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to create membership tier. Please try again.",
        variant: "destructive",
      });
    }
  };
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            List each benefit on a separate line
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tiers.map((tier: any) => {
            ...
            const benefits = JSON.parse(tier.benefits as string);
                ...
                <CardHeader className="bg-primary/5">
                  <div className="flex justify-between items-start">
                    ...
                    <Badge className="bg-primary text-white">
                      ${parseFloat(tier.price).toFixed(2)}/year
                    </Badge>
                  </div>
                </CardHeader>
