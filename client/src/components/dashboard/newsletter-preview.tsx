...
export const NewsletterPreview: React.FC = () => {
  ...
  const latestNewsletter = recentCampaigns?.[0];
      ...
      <Card>
        <CardHeader className="border-b border-gray-200">
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg font-medium text-gray-900">Latest Newsletter</CardTitle>
        ...
        <CardContent className="p-6">
          <div className="text-center py-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 mb-4">
              <i className="fas fa-envelope-open-text text-xl text-gray-400"></i>
            </div>
        ...
        <div className="flex flex-col lg:flex-row items-start space-y-4 lg:space-y-0 lg:space-x-6">
          <div className="lg:w-1/2">
            <div className="rounded-lg overflow-hidden bg-gray-100 h-40 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-16 h-16 text-gray-400">
          ...
          <div className="lg:w-1/2">
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <h5 className="font-medium text-gray-900">Newsletter Summary</h5>
